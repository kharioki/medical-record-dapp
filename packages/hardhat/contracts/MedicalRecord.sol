...
contract MedicalRecord {
    ...
    modifier contractOwnerOrDataOwner(address dataOwner) {
        require(
            msg.sender == owner || msg.sender == dataOwner,
    ...
    function getPatientData(
        ...
        public
        view
        contractOwnerOrDataOwner(_patientAddress)
        returns (
            uint256 id,
            address patientWalletAddress,
    ...
    function addPatientMedicalReport(
        address _patientWalletAddress,
    ...
    function getPatientTestResults()
        public
        view
        onlyOwner
        returns (PatientMedicalReport[] memory)
    {
